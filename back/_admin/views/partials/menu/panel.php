...
<?php if (false == $menu_superadmin) : ?>
    <li class="limenu">
        <a href="#" >
            <span class="ico gray notepad"></span><strong>Faqs</strong>
        </a>
        <ul class="level-1">
            <li><a href="<?php echo cms_url('faqs/categoria') ?>">Categorías</a></li>
            <li><a href="<?php echo cms_url('faqs') ?>">Faq</a></li>
        </ul>                     
    </li>
    <li class="limenu">
        <a href="#" >
            <span class="ico gray notepad"></span><strong>Media</strong>
        </a>
        <ul class="level-1">
            <li><a href="<?php echo cms_url('artists/artists') ?>">Artístas</a></li>
            <li><a href="<?php echo cms_url('artists/artists/media') ?>">Videos</a></li>
        </ul>                     
    </li>
    <li class="limenu">
        <a href="#" >
