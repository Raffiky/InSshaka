...
class Upload extends Back_Controller {
    ...
    public function index() {
        $id = $this->_post('page_id');
        $datos = $this->_datos->get_by_id($id);
        $datos->check_last_query();
        $targetDir = UPLOADSFOLDER . $datos->band->var;
        ...
        echo $datos->id;
        $save = $this->_save_relation($datos->id, $filePath, $thumb);
