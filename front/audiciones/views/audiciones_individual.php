...
<div class="selectores">
  <form action="<?php echo site_url('audiciones/buscar') ?>" method="get" accept-charset="utf8" class="buscar">    
    <div class="clr"></div>
    <div class="sebusca2">
      ...
      <div class="campo-reg-lab" style="width: 165px;">
        ...
        <div class="selectBox" id="select-medio">
          <?php echo form_dropdown('talento',$talents,$this->input->get('talento'),'style="width:188px;" class="comboBox1"') ?>
        </div>
      </div>
