<?php echo form_open_multipart('audiciones/save/' . ($edit_mode ? $datos->id : null), 'id="crear-form"', array('edit_mode' => $edit_mode)) ?>
  ...
  <div class="campo-reg-lab" style="width: 356px;">
    <div style="float:left">
      <div class="fecha2" style="margin: 0px;">
        <div class="audicion-fecha1" style=" margin-top: 8px; margin-right: 22px;">
          <label for="fecha_inicial">Fecha inicial<br><b>de Publicación</b></label></div>
      </div>
    ...
    <div style="float:left; width: 153px; margin-top: 20px;">
  ...
  <div class="campo-reg-lab" style="width: 195px; margin-top: 21px;">
  ...
  <div class="campo-reg-lab" id="genero_banda" style="width: 195px; margin-top: 21px; display: none">
  ...
  <div class="campo-reg-lab" style="width: 476px;">
    <div style="float:left">
      <div class="fecha2" style="margin: 0px;">
        <div class="audicion-fecha1" style=" margin-top: 8px; margin-right: 22px;">
          <label for="fecha_inicial">Fecha y hora<br><b>de Audición</b></label></div>
      </div>
      <input name="fecha_audicion" id="fecha_audicion" type="text" class="campo2" placeholder="Año - Mes - Día" readonly="true" value="<?php echo $edit_mode ? $datos->fecha_audicion : $this->input->post('fecha_audicion') ?>"  />
    </div>
    <div style="float:left; width: 153px; margin-top: 20px;">
  ...
  <div class="campo-reg-lab" style="width: 195px; margin-top: 21px;">
    <label style="padding-left: 4px;">No. Aplicaciones</label>
    <div id='eighth-help' class="help-inshaka" title="<span class='title-help'>Cuantos cupos disponibles hay para la audición?</span>
        ...
        style="float:right; margin-left: 115px; margin-top: -20px;position:absolute">
    </div>    
