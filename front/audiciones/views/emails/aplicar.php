...
<p><img src="http://inshaka.com/imagenes_mailing/templatehigh.png" width="749" /></p>
    Hola, <strong style="color:#E01D71"><?= $user_owner->first_name,' ', $user_owner->last_name ?></strong>, ha aplicado a una audición que tu creaste!<br><br>
           Para ver el perfil de <strong style="color:#E01D71"><?= $user_apply->username ?> </strong>,
           haz click en: <a href="http://inshaka.com/perfil/<?= $user_apply->inshaka_url ?>"><img src="http://www.inshaka.com/assets/images/email/ver_mas.png" /></a>
         </p>
