...
//            exit;
	    ...
	    $this->_datos->where('is_proveedor', false);
            $this->_datos->where_in_related_group('name', array('usuarios'))->order_by('username', 'random')->get_paged($page, 12);
    ...
    public function restablecer($page = 1) {
