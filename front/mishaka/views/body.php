    ...
    <div class="tab_container">
        ...
        <div class="sebusca-cont">
            ...
            <div class="sebusca-selectores">
                <form id="filtrar-busqueda" action="<?php echo site_url('mishaka/buscar') ?>">
                    ...
                    <div class="sebusca2">
                        ...
                        <div class="help-inshaka" title="<span class='title-help'>Buscador Mishaka</span>
                            <div class='content-help'>
                            <p>Usa este buscador para encontrar otros músicos e interactuar con ellos</p>
                            </div>" 
                            style="float:right; margin-right: 429px; margin-top: -48px;">
                       </div>
                        ...
                        <div class="campo-reg-lab" style="width: 165px;">
                        	<label style="padding-left: 4px;">Necesitas banda</label>
                            <div class="selectBox s1">
                              <select style="width:156px;" class="comboBox1" name="necesitas_band" >
                                ...
                                <div class="res-perfil">
                                    <div class="foto-banda">
                                        <a href="<?php echo site_url('perfil/' . $dato->inshaka_url) ?>" style="display:block; height:201px; overflow:hidden;">
                                          ...
                                          <?php if(!$user_photo->get_photo($dato->id)) : ?>
                                            <img src="images/imagensino.png" style="width:253px;" >
                                            <?php else: ?>
                                             <img width="253" height="205" src="<?php echo uploads_url($user_photo->get_photo($dato->id)) ?>" style="width:253px;">
                                              <?php endif; ?>
                                         </a>
                                        <div class="res-datos">
                                            <div class="res-txt">Nombre: <b><?php echo $dato->first_name.' '.$dato->last_name ?></b></div>
