...
<div class="contenido">
    <div class="clasificados-cont">
        <ul class="tabs">
            ...
            <li class="t8 <?php echo $seccion == 'crear_anuncio' ? 'active' : null ?>"><a href="<?= $es_usuario ? site_url('clasificados/crear_anuncio') : site_url('usuarios/login?continue-uri=clasificado/crear_anuncio') ?>">Crear Anuncio</a></li>
        </ul>
    </div>
