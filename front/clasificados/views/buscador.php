...
<?php if ($datos->exists()) : ?>
    <div id="contenu3">
        <?php foreach ($datos as $dato) : ?>
            <a href="<?php echo $es_usuario ? sprintf($urls->clasificado_detalle, $dato->id, $dato->var) : site_url('usuarios/login?continue-uri=clasificado/'.$dato->id.'/'.$dato->var) ?>"><div class="resultado">
                    ...
                    <div class="clr"></div>
                    <div class="resultado-desc2"><b><?php echo $dato->descripcion ?></div>


                    <a href="<?php echo $es_usuario ? sprintf($urls->clasificado_detalle, $dato->id, $dato->var) : site_url('usuarios/login?continue-uri=clasificado/'.$dato->id.'/'.$dato->var) ?>"><div class="ver-mas">Ver más</div></a>
