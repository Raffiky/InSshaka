<div class="selectores">
  ...
  <div class="selectBox" id="select-largo2">
    <label style="padding-left: 4px;">Categoria del anuncio</label>
    <?php echo form_dropdown('clasificados_categoria_id', $categorias, $edit_mode ? $datos->clasificados_categoria_id : $this->input->post('clasificados_categoria_id'), 'style="width:315px;" class="comboBox1"') ?>
  </div>
  </div>
  <div class="clear"></div>
  ...
  <div class="selectores-publicar" style="position:relative;">
    ...
    <input name="fecha_cierre" class="campo4" type="text" readonly="true" placeholder="Fecha de cierre" value="<?php echo $edit_mode ? $datos->fecha_cierre : $this->input->post('fecha_cierre') ?>"> 
  ...
  <div class="area-cont1"><textarea name="descripcion" class="area1" placeholder="Descripción (220 Caracteres)" style="resize: none;"><?php echo $edit_mode ? $datos->descripcion : $this->input->post('descripcion') ?></textarea></div>
