        ...
        <div class="resultado-detalle">
          ...
          <div class="resultado-desc3">
            ...
            <div class="anuncio-datos">
              ...
              <div><b>Fecha de cierre:</b> <?php echo fecha_spanish_full($datos->fecha_cierre) ?></div>
               <div class="regis-subtit">Todavía puedes aplicar a este clasificado por <?php echo $datos->dias_restantes  ?> días más.</div> 
          ...
          <?php if (false === $is_owner) : ?>
            <?php if (true === $can_apply) : ?>
              ...
              <div class="clr"></div>
            <?php else: ?>
              <!--<div class="regis-subtit">Todavía puedes aplicar a este clasificado por <?php //echo $dias_restantes  ?> días más.</div> -->
            <?php endif; ?>
          <?php endif; ?>
        </div>
      </div>
