...
<div class="bgEncabezado2" >
    <div class="conEncabezado2">
        <div class="ico-seccion"><img src="http://local.inshaka.com/assets/images/ico-seccion1.png" /></div>
        <div id="txSeccion2">
...
<div class="perfil-cont" >
    <div class="perfil-cont-iz2" id="perfil-cont-iz">
        <a class="bot-rosa2 cambia-cont" href="<?php echo site_url('perfil/'.$datos->inshaka_url) ?>" style="margin-left: 0;margin-bottom: 20px;">Volver al perfil</a>
        <div class="clr"></div>
                        ...
                        <?php foreach ($datos->users_video as $user_video) : $user_video->get_oembed() ?>
                            <div class="album">
                                ...
                                <a class="group iframe" href="<?php echo $user_video->oembed->url ?>" rel="fancy-gallery-iframe">
                                    ...
                                    <div class="mas" style=" margin-left: 136px; margin-top: -45px;"><img src="http://local.inshaka.com/assets/images/mas.png" /></div>
                                </a>
