                ...
                <div id="contenu3">
                    <?php foreach ($datos as $directorio) : ?>
                        <div class="resultado">
                            ...
                            <div class="resultado-desc"><?php echo substr($directorio->descripcion, 0, 350) ?> ...</div>
                            
                            <div class="opciones-ico">
                                <div class="ver-mas"><a href="<?php echo site_url('perfil/'.$usuario->get_provider($directorio->user_id)) ?>">Ver más</a></div>
