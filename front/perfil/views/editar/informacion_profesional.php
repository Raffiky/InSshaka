...
<div class="contenido edit-perfil-cont">
  ...
  <div class="selectores profesional" id="registro">
    ...
    <div class="registro-campos">
      <div class="campo-reg-lab" style="<?= $proveedor->is_proveedor ? 'display:none' : null ?>">
      ...
      <div class="campo-reg-lab" style="<?= !$proveedor->is_proveedor ? 'display:none' : null ?>">
        ...
        <div class="selectBox"  id="select-largo2">
          <input name="id_categoria_proveedor" class="campo" value="<?php echo $categoria->get_cat_provider($proveedor->id_categoria_proveedor)?>" disabled="disabled"  />
        </div>
      </div>
      ...
      <div class="campo-reg-lab" style="<?= !$proveedor->is_proveedor ? 'display:none' : null ?>">
        ...
        <div class="selectBox"  id="select-largo2">
          <input name="phone_provider" class="campo" value="<?php echo $datos->phone_provider?>" />
        </div>
      </div>
    ...
    <div class="registro-campos">
      ...
      <div class="campo-reg-lab" style="<?= $proveedor->is_proveedor || $proveedor->is_band ? 'display:none' : null ?>">
      ...
      <div class="campo-reg-lab" style="<?= $proveedor->is_proveedor ? 'display:none' : null ?>">
        ...
        <div class="selectBox"  id="select-largo2">
          <input name="influencias" type="text"  class="campo" placeholder="influencia 1, influencia 2, ..." value="<?php echo $datos->influencias ?>"  />
        </div>
      </div>
    ...
    <div class="registro-campos">
      ...
      <div class="campo-reg-lab">
        ...
        <div class="selectBox"  id="select-largo2">
          <input name="sitio_web" type="url" class="campo" placeholder="http://www.misitio.com" value="<?php echo $datos->sitio_web ?>" />
        </div>
      </div>
      ...
      <div class="campo-reg-lab" style="<?= $proveedor->is_proveedor ? 'display:none' : null ?>">
        ...
        <div class="selectBox" id="select-largo2">
          <input name="ubicacion" type="text" class="campo" placeholder="Digite su dirección completa" value="<?php echo $datos->ubicacion ?>"  />
        </div>
      </div>
    ...
    <div>
      <div class="lista-check3" style="float:left; width:252px; <?= $proveedor->is_proveedor ? 'display: none' : null ?>">
      ...
      <div class="lista-check3" style="float:left;width:740px; <?= $proveedor->is_proveedor ? 'display:none' : null ?>">
