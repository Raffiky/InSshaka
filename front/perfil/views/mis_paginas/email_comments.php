...
<p><img src="http://inshaka.com/imagenes_mailing/templatehigh.png" width="749" /></p>
         Hola, <strong style="color:#E01D71"><?= $page->band->name ?></strong><br>
         ...
         <p style="text-align: justify">
           Para ver <strong style="color:#E01D71">tu</strong> perfil haz click en: <a href="http://inshaka.com/perfil/pagina/<?= $page->var ?>"><img src="http://www.inshaka.com/assets/images/email/ver_mas.png" /></a>
         </p>
         <p style="text-align: justify">
           Team InShaka<br>
