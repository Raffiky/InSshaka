...
class Build_a_band extends Front_Controller {
    ...
    public function index($seccion = 'crear_banda') {
        ...
        if($this->is_usuario())
          $datos->usuario = $user->get_current();
    ...
    public function editar_concierto($concierto_id = null) {
        $datos = new \Concierto($concierto_id);

        $dato = $datos->get();

        return $this->crear_concierto();
    }
    ...
    public function save_concierto() {
        ...
        $datos->tipo_concierto = $this->_post('tipo_concierto');
