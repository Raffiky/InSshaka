                ...
                <div class="band-info">
                    ...
                    <div class="band-cont">
                        ...
                        <div class="campo-reg-lab">
                            ...
                            <div class="selectBox" id="select-largo">
                                <?php echo form_dropdown('subgenero_musical_uno', $musical_genders, null, 'style="width:386px;"   class="comboBox1" '); ?>
                                <div class="clr"></div>
                            </div>
                        </div>
                        ...
                        <div class="campo-reg-lab">
                            ...
                            <div class="selectBox" id="select-largo">
                                <?php echo form_dropdown('subgenero_musical_dos', $musical_genders, null, 'style="width:386px;"   class="comboBox1" '); ?>
                                <div class="clr"></div>
                            </div>
                        </div>
                        ...
                        <div class="campo-reg-lab">
                            ...
                            <div class="selectBox"  id="select-peq" >
                                <select  style="width:122px;"   class="comboBox1" name="tipo_concierto"  >
                                    <option selected="selected" value="">Tipo</option>
                                    <option value="público" <?php if($this->input->post('tipo_concierto') == 'público'){echo 'selected';} ?>>Público</option>
                                    <option value="privado" <?php if($this->input->post('tipo_concierto') == 'privado'){echo 'selected';} ?>>Privado</option>
                                </select>
                                <div class="clr"></div>
                            </div>
                            <div class="selectBox"  id="select-peq">
