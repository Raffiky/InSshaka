...
<div class="contenido">
    <div class="buildaband-cont">
        <ul class="tabs">
            <li style="<?php echo $seccion == 'crear_banda' ? 'display:block' : 'display:none' ?>" class="t3 <?php echo $seccion == 'crear_banda' ? 'active' : '' ?>"><a href="<?php echo site_url('build-a-band/crear-banda') ?>">Crear Banda</a></li>
            <li style="<?php echo $seccion == 'crear_concierto' ? 'display:block' : 'display:none' ?>" class="t4 <?php echo $seccion == 'crear_concierto' ? 'active' : '' ?>"><a href="<?php echo site_url('build-a-band/crear-concierto') ?>">Crear Concierto</a></li>
...
<script defer src="<?php echo base_url('assets/js/build-a-band.js') ?>"></script>