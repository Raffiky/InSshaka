      ...
      <div class="content_follower">
        ...
        <div class="follower_new">
          <div style="<?= !empty($intelligence->users_song_id) ? null : 'float:left' ?>">
            ...
            <?php elseif(!empty($intelligence->users_video_id)) : ?>
              <?php if(is_youtube_url($intelligence->users_video->url)) :  $intelligence->users_video->get_oembed()?>
              <a class="group iframe" href="<?php echo $intelligence->users_video->oembed->url ?>" rel="fancy-gallery-iframe">
                  <img src="<?= $intelligence->users_video->oembed->thumbnail_url ?>" style="width: 80px; height: 80px; position: absolute" />
